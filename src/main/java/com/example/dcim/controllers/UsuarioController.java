...
public class UsuarioController {
    ...
    // Endpoint para verificar si un email existe (usado por login.html)
    @GetMapping("/exists")
    @ResponseBody
    public boolean verificarExisteEmail(@RequestParam("email") String email) {
        return usuarioService.existeEmail(email);
    }

    // Endpoint para validar credenciales (usado por login.html)
    @GetMapping("/validate")
    @ResponseBody
